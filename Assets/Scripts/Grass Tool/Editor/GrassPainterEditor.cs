...
namespace UnityEditorInternal
{
    ...
    public class GrassPainterEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var lsdfga = LayerMask.GetMask(GetLayers());
            //LayerMask tempMask = EditorGUILayout.MaskField("Hit Mask", lsdfga, GetLayers());
            LayerMask tempMask = EditorGUILayout.MaskField("Hit Mask", InternalEditorUtility.LayerMaskToConcatenatedLayersMask(grassPainter.hitMask), GetLayers());
            //grassPainter.hitMask = LayerMask.;
